...
class CommonsMetadata {
	...
	public static function onGetExtendedMetadata( &$combinedMeta, File $file, IContextSource $context, $singleLang, &$maxCache ) {
		...
		$categories = self::getCategories( $file, $combinedMeta );
	...
	/**
	 * @param File $file
	 * @param array $combinedMeta metadata passed to the onGetExtendedMetadata hook
	 * @return array list of category names in human-readable format
	 */
	protected static function getCategories( File $file, array $combinedMeta ) {
		$categories = array();
		...
		if ( $file instanceof LocalFile ) {
			...
			$categories = explode( '|', $combinedMeta['Categories']['value'] );
		} else {
